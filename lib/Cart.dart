          ...
          actions: <Widget>[
            Padding(
              ...
              child: RaisedButton(onPressed: (){
                ...
                Navigator.push(context,MaterialPageRoute(builder: (context) => Text('Pending')));
              },
                elevation: 10,
              ...
              Card(
                ...
                child: Column(
                  children: <Widget>[
                    ...
                    Text('cloth1'.toUpperCase(),textAlign: TextAlign.center,
                      ...
                      children: <Widget>[
                        ...
                        SizedBox(
                          child: CachedNetworkImage(
                            imageUrl: 'https://imgur.com/qyLAZf8.jpg',
              ...
              Card(
                ...
                child: Column(
                  children: <Widget>[
                    ...
                    Text('cloth2'.toUpperCase(),textAlign: TextAlign.center,
                      style: TextStyle(fontWeight: FontWeight.w600,fontSize: 18,),),
                    Row(
                      mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                      children: <Widget>[
                        ...
                        SizedBox(
                          child: CachedNetworkImage(
                            imageUrl: 'https://imgur.com/MRWrLQl.jpg',
                            repeat: ImageRepeat.noRepeat,
                            fit: BoxFit.contain,),
                          height: 130,
                          width: 130,
              ...
              Card(
                ...
                child: Column(
                  children: <Widget>[
                    ...
                    Text('cloth3'.toUpperCase(),textAlign: TextAlign.center,
                      style: TextStyle(fontWeight: FontWeight.w600,fontSize: 18,),),
                    Row(
                      mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                      children: <Widget>[
                        ...
                        SizedBox(
                          child: CachedNetworkImage(
                            imageUrl: 'https://imgur.com/WBBpVKw.jpg',
                            repeat: ImageRepeat.noRepeat,
                            fit: BoxFit.contain,),
                          height: 130,
                          width: 130,
